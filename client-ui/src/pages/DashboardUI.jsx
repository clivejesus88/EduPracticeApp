    ...
    <div className="flex-1 overflow-y-auto p-4 sm:p-6 md:p-8 pb-24 md:pb-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
          <div>
            <h1 className="text-3xl md:text-4xl font-semibold tracking-tight text-white mb-2">Welcome back, Sarah</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5 mb-8">
          ...
          <div className="bg-gradient-to-br from-[#111827] to-[#0D0F1B] border border-white/5 rounded-xl p-5 hover:border-blue-500/20 hover:shadow-lg hover:shadow-blue-500/10 transition-all">
            ...
            <p className="text-sm text-slate-400 mb-2">Questions Solved</p>
          ...
          <div className="bg-gradient-to-br from-[#111827] to-[#0D0F1B] border border-white/5 rounded-xl p-5 hover:border-purple-500/20 hover:shadow-lg hover:shadow-purple-500/10 transition-all">
            ...
            <p className="text-sm text-slate-400 mb-2">Average Accuracy</p>
          ...
          <div className="bg-gradient-to-br from-[#111827] to-[#0D0F1B] border border-white/5 rounded-xl p-5 hover:border-rose-500/20 hover:shadow-lg hover:shadow-rose-500/10 transition-all">
            ...
            <p className="text-sm text-slate-400 mb-2">Study Time</p>
          ...
          <div className="bg-gradient-to-br from-[#111827] to-[#0D0F1B] border border-white/5 rounded-xl p-5 hover:border-[#f99c00]/20 hover:shadow-lg hover:shadow-[#f99c00]/10 transition-all">
            ...
            <p className="text-sm text-slate-400 mb-2">Global Rank</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Activity Chart Area */}
            <div className="bg-gradient-to-br from-[#111827] to-[#0D0F1B] border border-white/5 rounded-xl p-6">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between mb-6 gap-4">
                <div>
                  <h3 className="text-lg font-semibold tracking-tight text-white">Learning Activity</h3>
                  <p className="text-sm text-slate-400 mt-1">Questions answered over the last 7 days</p>
                </div>
            ...
            <div className="bg-gradient-to-br from-[#111827] to-[#0D0F1B] border border-white/5 rounded-xl p-6">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-semibold tracking-tight text-white">Recent Sessions</h3>
                <button className="text-sm text-[#f99c00] hover:text-[#f99c00]/80 font-medium transition-colors">View all</button>
              </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-[#111827] to-[#0D0F1B] border border-white/5 rounded-xl p-6 relative overflow-hidden group hover:border-[#f99c00]/20 transition-all">
              ...
              <div className="relative z-10">
                ...
                <p className="text-sm text-slate-400 mb-6">Complete 50 questions daily to keep your streak alive.</p>
                ...
                <p className="text-sm font-medium text-[#f99c00]">18 questions remaining</p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#111827] to-[#0D0F1B] border border-white/5 rounded-xl p-6">
              ...
              <button className="w-full mt-6 py-3 rounded-lg border border-white/10 hover:border-[#f99c00]/30 text-sm font-medium text-slate-300 hover:text-white hover:bg-white/5 transition-all">
