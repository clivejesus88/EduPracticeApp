        ...
        <div className="bg-[#111827] border border-gray-800 rounded-2xl p-5 sm:p-8">
          ...
          <form className="space-y-4 sm:space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex justify-end">
              <button
                ...
                disabled={loading || !email || resetEmailSent}
          ...
          <div className="flex justify-center">
            <button
              ...
              disabled={loading}
              className="w-md py-2.5 px-6 bg-[#1a1f2e] border border-gray-700 rounded-lg text-gray-300 hover:text-white hover:border-gray-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
